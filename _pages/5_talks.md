...
<br/><br/>
-  <span style="color:red">(June 2024)</span>\
    -   **"An Introduction to Quantum Computing"** ([Slides](/assets/talks_materials/Nature_is_not_classical.pdf))\
      <span style="color:green;font-weight:700;font-size:12px">
    In the _Design of Algorithms_ course at SUT, invited by [Shahram Khazaei](https://sharif.ir/~shahram.khazaei/home.html)</span>  
<br/><br/>
